...
from ..attention import FeedForwardSwiGLU, HiDreamAttention
from ..attention_processor import HiDreamAttnProcessor_flashattn
from ..embeddings import EmbedND, OutEmbed, PatchEmbed, PooledEmbed, TimestepEmbed
...
class HiDreamImageSingleTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        image_tokens_masks: torch.FloatTensor | None = None,
        text_tokens: torch.FloatTensor | None = None,
        adaln_input: torch.FloatTensor | None = None,
