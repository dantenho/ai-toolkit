...
# [diffusers] -> kohya
embedding_mapping = {"text_encoders_0": "clip_l", "text_encoders_1": "clip_g"}
...
# load keymap
with open(sdxl_keymap_path) as f:
    ...
    with safe_open(lora_path, framework="pt", device="cpu") as f:
        ...
        for key in keys:
            ...
            if new_key.endswith(".lora_down.weight"):
                ...
                lora_state_dict[alpha_key] = (
                    torch.ones(1).to(tensor.device, tensor.dtype) * lora_rank
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument("embedding_path", type=str, help="Path to embedding file")
    ...
    lora_state_dict, embedding_state_dict = convert_cog(
        args.lora_path, args.embedding_path
    )
