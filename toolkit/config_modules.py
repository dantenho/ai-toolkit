...
class TrainConfig:
    def __init__(self, **kwargs):
        ...
        self.adapter_assist_name_or_path: str | None = kwargs.get(
            "adapter_assist_name_or_path"
        )
        self.adapter_assist_type: str | None = kwargs.get(
        ...
        self.guidance_loss_target: int | list[int, int] = kwargs.get(
...
class DatasetConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.control_path: str | list[str] = kwargs.get(
            "control_path"
        )  # depth maps, etc
