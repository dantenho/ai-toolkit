...
class Augments:
    def __init__(self, **kwargs):
        self.method_name = kwargs.get("method")
...
class CaptionMixin:
    def get_caption_item(self: "AiToolkitDataset", index):
        ...
        elif os.path.exists(default_prompt_path_with_ext) or os.path.exists(
            default_prompt_path
        ):
...
class CaptionProcessingDTOMixin:
    ...
    def load_caption(self: "FileItemDTO", caption_dict: dict | None = None):
        if self.raw_caption is not None:
            ...
            if os.path.exists(prompt_path):
                with open(prompt_path, encoding="utf-8") as f:
                    ...
                    if (
                        prompt.strip() == ""
                        and self.dataset_config.default_caption is not None
                    ):
    ...
    def get_caption(
        ...
        # handle dropout
        if (
            self.dataset_config.caption_dropout_rate > 0
...
class ImageProcessingDTOMixin:
    ...
    def load_and_process_image(
        ...
        if (
            w > h
            and self.scale_to_width < self.scale_to_height
            or h > w
            and self.scale_to_height < self.scale_to_width
        ):
...
class InpaintControlFileItemDTOMixin:
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        self.inpaint_path: str | None = None
        self.inpaint_tensor: torch.Tensor | None = None
        dataset_config: DatasetConfig = kwargs.get("dataset_config")
...
class ControlFileItemDTOMixin:
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        self.control_path: str | list[str] | None = None
        self.control_tensor: torch.Tensor | None = None
        self.control_tensor_list: list[torch.Tensor] | None = None
        sd = kwargs.get("sd")
...
class ClipImageFileItemDTOMixin:
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        self.clip_image_path: str | None = None
        self.clip_image_tensor: torch.Tensor | None = None
        self.clip_image_embeds: dict | None = None
        self.clip_image_embeds_unconditional: dict | None = None
        self.has_clip_augmentations = False
        self.clip_image_aug_transform: None | A.Compose = None
        self.clip_image_processor: None | CLIPImageProcessor = None
        self.clip_image_encoder_path: str | None = None
        ...
        self.clip_vision_unconditional_paths: list[str] | None = None
        self._clip_vision_embeddings_path: str | None = None
        dataset_config: DatasetConfig = kwargs.get("dataset_config")
        if (
...
class AugmentationFileItemDTOMixin:
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        self.unaugmented_tensor: torch.Tensor | None = None
        # self.augmentations: Union[None, List[Augments]] = None
        self.dataset_config: DatasetConfig = kwargs.get("dataset_config")
        self.aug_transform: None | A.Compose = None
    ...
    def augment_spatial_control(
        self: "FileItemDTO", img: Image, transform: None | transforms.Compose
    ):
...
class MaskFileItemDTOMixin:
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        if dataset_config.alpha_mask:
            ...
            self.mask_path = kwargs.get("path")
...
class UnconditionalFileItemDTOMixin:
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        self.unconditional_path: str | None = None
        self.unconditional_tensor: torch.Tensor | None = None
        self.unconditional_latent: torch.Tensor | None = None
...
class PoiFileItemDTOMixin:
    ...
    def __init__(self: "FileItemDTO", *args, **kwargs):
        ...
        self.poi: str | None = dataset_config.poi
        self.has_point_of_interest = self.poi is not None
        self.poi_x: int | None = None
        self.poi_y: int | None = None
        self.poi_width: int | None = None
        self.poi_height: int | None = None
...
class LatentCachingFileItemDTOMixin:
    def __init__(self, *args, **kwargs):
        ...
        if hasattr(super(), "__init__"):
            super().__init__(*args, **kwargs)
        self._encoded_latent: torch.Tensor | None = None
        self._latent_path: str | None = None
...
class TextEmbeddingFileItemDTOMixin:
    def __init__(self, *args, **kwargs):
        ...
        if hasattr(super(), "__init__"):
            super().__init__(*args, **kwargs)
        self.prompt_embeds: PromptEmbeds | None = None
        self._text_embedding_path: str | None = None
                    ...
                    if file_item.encode_control_in_text_embeddings:
                        ...
                        for i in range(len(control_path_list)):
                            try:
                                ...
                                print_acc(f"Error: {e}")
                                print_acc(
                                    f"Error loading control image: {control_path_list[i]}"
                                )
