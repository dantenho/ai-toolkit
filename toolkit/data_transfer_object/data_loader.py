...
class FileItemDTO(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.width: int = w
        self.height: int = h
        self.dataloader_transforms = kwargs.get("dataloader_transforms")
        super().__init__(*args, **kwargs)

        # self.caption_path: str = kwargs.get('caption_path', None)
        self.raw_caption: str = kwargs.get("raw_caption")
...
class DataLoaderBatchDTO:
    def __init__(self, **kwargs):
        try:
            self.file_items: list[FileItemDTO] = kwargs.get("file_items")
            ...
            self.control_tensor_list: list[list[torch.Tensor]] | None = None
            ...
            self.unconditional_latents: torch.Tensor | None = None
            self.clip_image_embeds: list[dict] | None = None
            self.clip_image_embeds_unconditional: list[dict] | None = None
            self.sigmas: torch.Tensor | None = (
                None  # can be added elseware and passed along training code
            )
            self.extra_values: torch.Tensor | None = (
