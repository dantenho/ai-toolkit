...
from toolkit.photomaker import FuseModule, PhotoMakerCLIPEncoder
from toolkit.prompt_utils import PromptEmbeds
from toolkit.saving import load_custom_adapter_model
...
class CustomAdapter(torch.nn.Module):
    def __init__(
        ...
        self.vision_encoder: PhotoMakerCLIPEncoder | CLIPVisionModelWithProjection = (
            None
        )
        ...
        self.position_ids: list[int] | None = None
        ...
        self.te: T5EncoderModel | CLIPTextModel = None
        ...
        self.conditional_embeds: torch.Tensor | None = None
        self.unconditional_embeds: torch.Tensor | None = None

        self.cached_control_image_0_1: torch.Tensor | None = None
    ...
    def setup_clip(self):
        ...
        if self.config.type == "photo_maker":
            ...
            self.config.image_encoder_arch == "siglip"
            or self.config.image_encoder_arch == "siglip2"
        ):
        ...
        if "id_encoder" in state_dict and (
            ...
            if len(fuse_weights) > 0:
                try:
                    ...
                    print(e)
                    # force load it
                    print("force loading fuse module as it did not match")
    ...
    def trigger_pre_te(
        self,
        tensors_0_1: torch.Tensor | None = None,
        tensors_preprocessed: torch.Tensor
        | None = None,  # preprocessed by the dataloader
        is_training=False,
        has_been_preprocessed=False,
        batch_tensor: torch.Tensor | None = None,
        quad_count=4,
        batch_size=1,
    ) -> PromptEmbeds:
