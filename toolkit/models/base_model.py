...
class BaseModel:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model: None | Transformer2DModel | UNet2DConditionModel
        self.text_encoder: (
        ...
        self.accuracy_recovery_adapter: None | LoRASpecialNetwork = None
                ...
                for i in tqdm(
                    ...
                    if self.sample_prompts_cache is not None:
                        ...
                        if (
                            ...
                            or gen_config.ctrl_img_1 is not None
                            or gen_config.ctrl_img_2 is not None
                            or gen_config.ctrl_img_3 is not None
                        ):
                        ...
                        if (
                            ...
                            if gen_config.ctrl_img is not None:
                                ctrl_img = Image.open(gen_config.ctrl_img).convert(
                                    "RGB"
                                )
                            ...
                            if gen_config.ctrl_img_1 is not None:
                                ctrl_img_1 = Image.open(gen_config.ctrl_img_1).convert(
                                    "RGB"
                                )
                                # convert to 0 to 1 tensor
                                ctrl_img_1 = (
                            ...
                            if gen_config.ctrl_img_2 is not None:
                                ctrl_img_2 = Image.open(gen_config.ctrl_img_2).convert(
                                    "RGB"
                                )
                                # convert to 0 to 1 tensor
                                ctrl_img_2 = (
                            ...
                            if gen_config.ctrl_img_3 is not None:
                                ctrl_img_3 = Image.open(gen_config.ctrl_img_3).convert(
                                    "RGB"
                                )
                                # convert to 0 to 1 tensor
                                ctrl_img_3 = (
                            ...
                            if self.has_multiple_control_images:
                                ...
                                ctrl_img = (
                                    ctrl_img_list[0] if len(ctrl_img_list) > 0 else None
                                )
